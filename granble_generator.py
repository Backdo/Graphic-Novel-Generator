...
class StoryboardGenerator:
    ...
    def setup_gui(self):
        ...
        ttk.Button(button_frame, text="설정 불러오기", command=self.load_config_dialog).pack(side=tk.LEFT, padx=(0, 5))
        ...
        ttk.Button(button_frame, text="불러오기", command=self.load_storyboard).pack(side=tk.LEFT, padx=(0, 5))
...
스토리보드를 작성해주세요:"""
    ...
    def display_current_page(self):
        ...
        if self.pages:
            ...
            # 지시문 + 헤더 + 페이지 내용 통합
            full_content = "Draw a graphic novel based on the following storyboard.\n\n"
